...
TARGET_FILE = Path(__file__).resolve().parents[3] / "src/coilSense/simu/bcaNeith_coilSensitivitySimulation2.py"
EXPECTED_FUNCTION_NAME = "bcaNeith_coilSensitivitySimulation2"
