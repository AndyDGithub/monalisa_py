...
import inspect
import pytest
pytestmark = pytest.mark.skip(reason="MATLAB source appears invalid and unreferenced in call graph; undefined identifiers: Fs_ref, SI, bandPass_filter, imNav, ind_SI_max, ind_SI_min, ind_shot_max, ind_shot_min")


TARGET_FILE = Path(__file__).resolve().parents[4] / "demo/script_demo/script_card_resp_binning_SI/lineMask_resp_fromSI_script.py"
EXPECTED_FUNCTION_NAME = "lineMask_resp_fromSI_script"
