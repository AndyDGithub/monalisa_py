...
import inspect
import pytest
pytestmark = pytest.mark.skip(reason="MATLAB source appears invalid and unreferenced in call graph; undefined identifiers: prescan_body, prescan_surface")


TARGET_FILE = Path(__file__).resolve().parents[4] / "demo/script_demo/script_coilSense/coilSense_from_prescan_images_script.py"
EXPECTED_FUNCTION_NAME = "coilSense_from_prescan_images_script"
