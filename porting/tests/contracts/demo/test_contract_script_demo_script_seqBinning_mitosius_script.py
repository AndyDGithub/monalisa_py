...
import inspect
import pytest
pytestmark = pytest.mark.skip(reason="MATLAB source appears invalid and unreferenced in call graph; undefined identifiers: gca, roipoly")


TARGET_FILE = Path(__file__).resolve().parents[4] / "demo/script_demo/script_seqBinning/mitosius_script.py"
