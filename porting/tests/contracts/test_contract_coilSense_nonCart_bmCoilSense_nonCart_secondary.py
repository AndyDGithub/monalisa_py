...
TARGET_FILE = Path(__file__).resolve().parents[3] / "src/coilSense/nonCart/bmCoilSense_nonCart_secondary.py"
EXPECTED_FUNCTION_NAME = "bmCoilSense_nonCart_secondary"
