...
import inspect
import pytest
pytestmark = pytest.mark.skip(reason="MATLAB source appears invalid and unreferenced in call graph; undefined identifiers: Access, GetAccess, SetAccess, bmPointList, handle, private, public")


TARGET_FILE = Path(__file__).resolve().parents[4] / "src/geomN/bmPointList.py"
EXPECTED_FUNCTION_NAME = "bmTraj"
