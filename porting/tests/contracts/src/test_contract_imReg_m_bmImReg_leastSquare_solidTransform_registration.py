...
import inspect
import pytest
pytestmark = pytest.mark.skip(reason="MATLAB source appears invalid and unreferenced in call graph; undefined identifiers: T_0, bmImReg_solidTransform, initialSolidTransform, x_0, x_ref_0")


TARGET_FILE = Path(__file__).resolve().parents[4] / "src/imReg/m/bmImReg_leastSquare_solidTransform_registration.py"
