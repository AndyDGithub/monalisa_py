...
import inspect
import pytest
pytestmark = pytest.mark.skip(reason="MATLAB source appears invalid and unreferenced in call graph; undefined identifiers: bmSparseMat")


TARGET_FILE = Path(__file__).resolve().parents[4] / "src/readWrite/bmBinary2Array_sparseMat.py"
EXPECTED_FUNCTION_NAME = "bmBinary2Array_sparseMat"
