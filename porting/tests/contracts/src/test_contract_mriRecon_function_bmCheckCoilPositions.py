...
import inspect
import pytest
pytestmark = pytest.mark.skip(reason="MATLAB source appears invalid and unreferenced in call graph; undefined identifiers: figure, hold, on")


TARGET_FILE = Path(__file__).resolve().parents[4] / "src/mriRecon/function/bmCheckCoilPositions.py"
EXPECTED_FUNCTION_NAME = "bmCheckCoilPositions"
