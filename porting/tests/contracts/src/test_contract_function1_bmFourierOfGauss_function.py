...
import inspect
import pytest
pytestmark = pytest.mark.skip(reason="MATLAB source appears invalid and unreferenced in call graph; undefined identifiers: i1, k")


TARGET_FILE = Path(__file__).resolve().parents[4] / "src/function1/bmFourierOfGauss_function.py"
EXPECTED_FUNCTION_NAME = "bmFourierOfGauss_function"
