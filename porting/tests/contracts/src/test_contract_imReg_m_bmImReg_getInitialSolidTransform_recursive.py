...
import inspect
import pytest
pytestmark = pytest.mark.skip(reason="MATLAB source appears invalid and unreferenced in call graph; undefined identifiers: bmImReg_solidTransform, imMov, imRef, initialTranslationTransform, nIter_max")


TARGET_FILE = Path(__file__).resolve().parents[4] / "src/imReg/m/bmImReg_getInitialSolidTransform_recursive.py"
