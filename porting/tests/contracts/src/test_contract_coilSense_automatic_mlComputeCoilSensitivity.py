...
import inspect
import pytest
pytestmark = pytest.mark.skip(reason="MATLAB source appears invalid and unreferenced in call graph; undefined identifiers: clear")


TARGET_FILE = Path(__file__).resolve().parents[4] / "src/coilSense/automatic/mlComputeCoilSensitivity.py"
EXPECTED_FUNCTION_NAME = "mlComputeCoilSensitivity"
