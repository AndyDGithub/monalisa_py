...
TARGET_FILE = Path(__file__).resolve().parents[3] / "src/fourier123/map_function/partialCartesian/bmNakatsha_partialCartesian.py"
EXPECTED_FUNCTION_NAME = "bmNakatsha_partialCartesian"
