...
import inspect
import pytest
pytestmark = pytest.mark.skip(reason="MATLAB source appears invalid and unreferenced in call graph; undefined identifiers: DiagnosticsOutputPlugin, TestRunner, TestSuite, import, matlab")


TARGET_FILE = Path(__file__).resolve().parents[4] / "tests/run_all_tests.py"
EXPECTED_FUNCTION_NAME = "run_all_tests"
