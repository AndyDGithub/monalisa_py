...
import inspect
import pytest
pytestmark = pytest.mark.skip(reason="MATLAB source appears invalid and unreferenced in call graph; undefined identifiers: DiagnosticsOutputPlugin, TestRunner, TestSuite, XMLPlugin, import, matlab, message, results")


TARGET_FILE = Path(__file__).resolve().parents[4] / "tests/ci/run_ci_test_suite.py"
EXPECTED_FUNCTION_NAME = "run_ci_test_suite"
