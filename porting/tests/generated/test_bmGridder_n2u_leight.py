...
TARGET_FILE = Path(__file__).resolve().parents[4] / "monalisa_py/src/gridding123/m/bmGridder_n2u_leight.py"
...
def _load_target_function():
    ...
    return getattr(module, 'bmGridder_n2u_leight')
...
def test_expected_behavior_contract():
    # Source MATLAB file: gridding123/m/bmGridder_n2u_leight.m
