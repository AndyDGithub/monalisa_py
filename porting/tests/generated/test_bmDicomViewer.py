...
TARGET_FILE = Path(__file__).resolve().parents[4] / "monalisa_py/src/dicom/bmDicomViewer.py"
...
def _load_target_function():
    ...
    return getattr(module, 'bmDicomViewer')
...
def test_expected_behavior_contract():
    # Source MATLAB file: dicom/bmDicomViewer.m
