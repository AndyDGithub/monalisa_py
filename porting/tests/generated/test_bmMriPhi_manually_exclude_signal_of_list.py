...
TARGET_FILE = Path(__file__).resolve().parents[4] / "monalisa_py/src/mriPhi/bmMriPhi_manually_exclude_signal_of_list.py"
...
def _load_target_function():
    ...
    return getattr(module, 'bmMriPhi_manually_exclude_signal_of_list')
...
def test_expected_behavior_contract():
    # Source MATLAB file: mriPhi/bmMriPhi_manually_exclude_signal_of_list.m
