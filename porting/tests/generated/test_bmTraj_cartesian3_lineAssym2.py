...
TARGET_FILE = Path(__file__).resolve().parents[4] / "monalisa_py/src/traj3/bmTraj_cartesian3_lineAssym2.py"
...
def _load_target_function():
    ...
    return getattr(module, 'bmTraj_cartesian3_lineAssym2')
...
def test_expected_behavior_contract():
    # Source MATLAB file: traj3/bmTraj_cartesian3_lineAssym2.m
