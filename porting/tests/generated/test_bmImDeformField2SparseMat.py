...
TARGET_FILE = Path(__file__).resolve().parents[4] / "monalisa_py/src/gridding123/m/bmImDeformField2SparseMat.py"
...
def _load_target_function():
    ...
    return getattr(module, 'bmImDeformField2SparseMat')
...
def test_expected_behavior_contract():
    # Source MATLAB file: gridding123/m/bmImDeformField2SparseMat.m
