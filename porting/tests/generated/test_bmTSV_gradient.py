...
TARGET_FILE = Path(__file__).resolve().parents[4] / "monalisa_py/src/optim/bmTSV_gradient.py"
...
def _load_target_function():
    ...
    return getattr(module, 'bmTSV_gradient')
...
def test_expected_behavior_contract():
    # Source MATLAB file: optim/bmTSV_gradient.m
