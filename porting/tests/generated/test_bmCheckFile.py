...
TARGET_FILE = Path(__file__).resolve().parents[4] / "monalisa_py/src/readWrite/bmCheckFile.py"
...
def _load_target_function():
    ...
    return getattr(module, 'bmCheckFile')
...
def test_expected_behavior_contract():
    # Source MATLAB file: readWrite/bmCheckFile.m
