...
TARGET_FILE = Path(__file__).resolve().parents[4] / "monalisa_py/src/quickSolve/bmDoubleFA_solve.py"
...
def _load_target_function():
    ...
    return getattr(module, 'bmDoubleFA_solve')
...
def test_expected_behavior_contract():
    # Source MATLAB file: quickSolve/bmDoubleFA_solve.m
