...
TARGET_FILE = Path(__file__).resolve().parents[4] / "monalisa_py/src/fit1/bmMonoExpFit1.py"
...
def _load_target_function():
    ...
    return getattr(module, 'bmMonoExpFit1')
...
def test_expected_behavior_contract():
    # Source MATLAB file: fit1/bmMonoExpFit1.m
