...
TARGET_FILE = Path(__file__).resolve().parents[4] / "monalisa_py/src/sparseMat/m/bmSparseMat_bmSparseMat2matlabSparse.py"
...
def _load_target_function():
    ...
    return getattr(module, 'bmSparseMat_bmSparseMat2matlabSparse')
...
def test_expected_behavior_contract():
    # Source MATLAB file: sparseMat/m/bmSparseMat_bmSparseMat2matlabSparse.m
