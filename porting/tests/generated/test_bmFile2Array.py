...
TARGET_FILE = Path(__file__).resolve().parents[4] / "monalisa_py/src/readWrite/bmFile2Array.py"
...
def _load_target_function():
    ...
    return getattr(module, 'bmFile2Array')
...
def test_expected_behavior_contract():
    # Source MATLAB file: readWrite/bmFile2Array.m
