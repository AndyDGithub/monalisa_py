...
TARGET_FILE = Path(__file__).resolve().parents[4] / "monalisa_py/src/readWrite/bmCreateDir.py"
...
def _load_target_function():
    ...
    return getattr(module, 'bmCreateDir')
...
def test_expected_behavior_contract():
    # Source MATLAB file: readWrite/bmCreateDir.m
