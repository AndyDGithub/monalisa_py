...
TARGET_FILE = Path(__file__).resolve().parents[4] / "monalisa_py/src/function1/bmBigDoor_function.py"
...
def _load_target_function():
    ...
    return getattr(module, 'bmBigDoor_function')
...
def test_expected_behavior_contract():
    # Source MATLAB file: function1/bmBigDoor_function.m
