...
TARGET_FILE = Path(__file__).resolve().parents[4] / "monalisa_py/src/gridding123/m/bmGriddingMatrix_prepare.py"
...
def _load_target_function():
    ...
    return getattr(module, 'bmGriddingMatrix_prepare')
...
def test_expected_behavior_contract():
    # Source MATLAB file: gridding123/m/bmGriddingMatrix_prepare.m
