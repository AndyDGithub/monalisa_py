...
TARGET_FILE = Path(__file__).resolve().parents[4] / "monalisa_py/src/traj123/bmTraj_lineReshape.py"
...
def _load_target_function():
    ...
    return getattr(module, 'bmTraj_lineReshape')
...
def test_expected_behavior_contract():
    # Source MATLAB file: traj123/bmTraj_lineReshape.m
