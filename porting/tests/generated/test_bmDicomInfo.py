...
TARGET_FILE = Path(__file__).resolve().parents[4] / "monalisa_py/src/dicom/bmDicomInfo.py"
...
def _load_target_function():
    ...
    return getattr(module, 'bmDicomInfo')
...
def test_expected_behavior_contract():
    # Source MATLAB file: dicom/bmDicomInfo.m
