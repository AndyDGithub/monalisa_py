...
TARGET_FILE = Path(__file__).resolve().parents[4] / "monalisa_py/src/trajN/mlTrajFromPulseq.py"
...
def _load_target_function():
    ...
    return getattr(module, 'mlTrajFromPulseq')
...
def test_expected_behavior_contract():
    # Source MATLAB file: trajN/mlTrajFromPulseq.m
