...
TARGET_FILE = Path(__file__).resolve().parents[4] / "monalisa_py/src/sparseMat/m/bmSparseMat_vec_2.py"
...
def _load_target_function():
    ...
    return getattr(module, 'bmSparseMat_vec_2')
...
def test_expected_behavior_contract():
    # Source MATLAB file: sparseMat/m/bmSparseMat_vec_2.m
