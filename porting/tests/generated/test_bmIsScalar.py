...
TARGET_FILE = Path(__file__).resolve().parents[4] / "monalisa_py/src/arrayUtility/bmIsScalar.py"
...
def _load_target_function():
    ...
    return getattr(module, 'bmIsScalar')
...
def test_expected_behavior_contract():
    # Source MATLAB file: arrayUtility/bmIsScalar.m
