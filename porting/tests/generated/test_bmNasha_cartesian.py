...
TARGET_FILE = Path(__file__).resolve().parents[4] / "monalisa_py/src/fourier123/map_function/cartesian/bmNasha_cartesian.py"
...
def _load_target_function():
    ...
    return getattr(module, 'bmNasha_cartesian')
...
def test_expected_behavior_contract():
    # Source MATLAB file: fourier123/map_function/cartesian/bmNasha_cartesian.m
