...
TARGET_FILE = Path(__file__).resolve().parents[4] / "monalisa_py/src/mathOp/bmSquaredNorm.py"
...
def _load_target_function():
    ...
    return getattr(module, 'bmSquaredNorm')
...
def test_expected_behavior_contract():
    # Source MATLAB file: mathOp/bmSquaredNorm.m
