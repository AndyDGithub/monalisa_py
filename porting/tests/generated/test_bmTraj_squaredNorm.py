...
TARGET_FILE = Path(__file__).resolve().parents[4] / "monalisa_py/src/traj123/bmTraj_squaredNorm.py"
...
def _load_target_function():
    ...
    return getattr(module, 'bmTraj_squaredNorm')
...
def test_expected_behavior_contract():
    # Source MATLAB file: traj123/bmTraj_squaredNorm.m
