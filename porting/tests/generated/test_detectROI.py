...
TARGET_FILE = Path(__file__).resolve().parents[4] / "monalisa_py/src/coilSense/automatic/detectROI.py"
...
def _load_target_function():
    ...
    return getattr(module, 'detectROI')
...
def test_expected_behavior_contract():
    # Source MATLAB file: coilSense/automatic/detectROI.m
