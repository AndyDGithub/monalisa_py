...
TARGET_FILE = Path(__file__).resolve().parents[4] / "monalisa_py/src/arrayUtility/bmType.py"
...
def test_expected_behavior_contract():
    # Source MATLAB file: arrayUtility/bmType.m
