...
TARGET_FILE = Path(__file__).resolve().parents[4] / "monalisa_py/src/arrayUtility/bmCell2Array.py"
...
def _load_target_function():
    ...
    return getattr(module, 'bmCell2Array')
...
def test_expected_behavior_contract():
    # Source MATLAB file: arrayUtility/bmCell2Array.m
