...
TARGET_FILE = Path(__file__).resolve().parents[4] / "monalisa_py/src/optim/bmBackGradientT.py"
...
def _load_target_function():
    ...
    return getattr(module, 'bmBackGradientT')
...
def test_expected_behavior_contract():
    # Source MATLAB file: optim/bmBackGradientT.m
