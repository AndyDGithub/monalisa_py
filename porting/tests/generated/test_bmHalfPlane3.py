...
TARGET_FILE = Path(__file__).resolve().parents[4] / "monalisa_py/src/geom3/bmHalfPlane3.py"
...
def _load_target_function():
    ...
    return getattr(module, 'bmHalfPlane3')
...
def test_expected_behavior_contract():
    # Source MATLAB file: geom3/bmHalfPlane3.m
