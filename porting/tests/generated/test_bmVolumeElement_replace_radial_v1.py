...
TARGET_FILE = Path(__file__).resolve().parents[4] / "monalisa_py/src/geom123/bmVolumeElement_replace_radial_v1.py"
...
def _load_target_function():
    ...
    return getattr(module, 'bmVolumeElement_replace_radial_v1')
...
def test_expected_behavior_contract():
    # Source MATLAB file: geom123/bmVolumeElement_replace_radial_v1.m
