...
TARGET_FILE = Path(__file__).resolve().parents[4] / "monalisa_py/src/imDisp/bmImageViewerParam.py"
...
def _load_target_function():
    ...
    return getattr(module, 'bmImageViewerParam')
...
def test_expected_behavior_contract():
    # Source MATLAB file: imDisp/bmImageViewerParam.m
