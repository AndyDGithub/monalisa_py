...
TARGET_FILE = Path(__file__).resolve().parents[4] / "monalisa_py/src/geom2/bmTwoLinesIntersect.py"
...
def _load_target_function():
    ...
    return getattr(module, 'bmTwoLinesIntersect')
...
def test_expected_behavior_contract():
    # Source MATLAB file: geom2/bmTwoLinesIntersect.m
