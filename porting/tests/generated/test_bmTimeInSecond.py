...
TARGET_FILE = Path(__file__).resolve().parents[4] / "monalisa_py/src/time/bmTimeInSecond.py"
...
def _load_target_function():
    ...
    return getattr(module, 'bmTimeInSecond')
...
def test_expected_behavior_contract():
    # Source MATLAB file: time/bmTimeInSecond.m
