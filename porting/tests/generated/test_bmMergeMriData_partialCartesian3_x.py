...
TARGET_FILE = Path(__file__).resolve().parents[4] / "monalisa_py/src/mriRecon/function/bmMergeMriData_partialCartesian3_x.py"
...
def _load_target_function():
    ...
    return getattr(module, 'bmMergeMriData_partialCartesian3_x')
...
def test_expected_behavior_contract():
    # Source MATLAB file: mriRecon/function/bmMergeMriData_partialCartesian3_x.m
