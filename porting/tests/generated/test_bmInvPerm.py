...
TARGET_FILE = Path(__file__).resolve().parents[4] / "monalisa_py/src/arrayUtility/bmInvPerm.py"
...
def _load_target_function():
    ...
    return getattr(module, 'bmInvPerm')
...
def test_expected_behavior_contract():
    # Source MATLAB file: arrayUtility/bmInvPerm.m
