...
TARGET_FILE = Path(__file__).resolve().parents[4] / "monalisa_py/src/varargin/bmVarargin_N_u_dK_u.py"
...
def _load_target_function():
    ...
    return getattr(module, 'bmVarargin_N_u_dK_u')
...
def test_expected_behavior_contract():
    # Source MATLAB file: varargin/bmVarargin_N_u_dK_u.m
