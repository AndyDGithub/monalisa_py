...
TARGET_FILE = Path(__file__).resolve().parents[4] / "monalisa_py/src/image123/bmImLaplaceIterator.py"
...
def _load_target_function():
    ...
    return getattr(module, 'bmImLaplaceIterator')
...
def test_expected_behavior_contract():
    # Source MATLAB file: image123/bmImLaplaceIterator.m
