...
TARGET_FILE = Path(__file__).resolve().parents[4] / "monalisa_py/src/traj3/bmTraj_UTE_r.py"
...
def _load_target_function():
    ...
    return getattr(module, 'bmTraj_UTE_r')
...
def test_expected_behavior_contract():
    # Source MATLAB file: traj3/bmTraj_UTE_r.m
