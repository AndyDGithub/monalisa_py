...
TARGET_FILE = Path(__file__).resolve().parents[4] / "monalisa_py/src/rawDataReader/siemens/bmSiemensReadRawData.py"
...
def _load_target_function():
    ...
    return getattr(module, 'bmSiemensReadRawData')
...
def test_expected_behavior_contract():
    # Source MATLAB file: rawDataReader/siemens/bmSiemensReadRawData.m
