...
TARGET_FILE = Path(__file__).resolve().parents[4] / "monalisa_py/src/rawDataReader/siemens/dhSiemensReadMetaData.py"
...
def _load_target_function():
    ...
    return getattr(module, 'dhSiemensReadMetaData')
...
def test_expected_behavior_contract():
    # Source MATLAB file: rawDataReader/siemens/dhSiemensReadMetaData.m
