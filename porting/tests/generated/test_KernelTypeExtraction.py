...
TARGET_FILE = Path(__file__).resolve().parents[4] / "monalisa_py/src/fourier3/bcaNeith_kernelTypeExtraction3.py"
...
def _load_target_function():
    ...
    return getattr(module, 'KernelTypeExtraction')
...
def test_expected_behavior_contract():
    # Source MATLAB file: fourier3/bcaNeith_kernelTypeExtraction3.m
