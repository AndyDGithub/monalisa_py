...
TARGET_FILE = Path(__file__).resolve().parents[4] / "monalisa_py/src/rawDataReader/createRawDataReader.py"
...
def _load_target_function():
    ...
    return getattr(module, 'createRawDataReader')
...
def test_expected_behavior_contract():
    # Source MATLAB file: rawDataReader/createRawDataReader.m
