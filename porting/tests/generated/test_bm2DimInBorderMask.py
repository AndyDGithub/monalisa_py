...
TARGET_FILE = Path(__file__).resolve().parents[4] / "monalisa_py/src/mask2/bm2DimInBorderMask.py"
...
def _load_target_function():
    ...
    return getattr(module, 'bm2DimInBorderMask')
...
def test_expected_behavior_contract():
    # Source MATLAB file: mask2/bm2DimInBorderMask.m
