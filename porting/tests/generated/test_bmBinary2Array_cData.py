...
TARGET_FILE = Path(__file__).resolve().parents[4] / "monalisa_py/src/readWrite/bmBinary2Array_cData.py"
...
def _load_target_function():
    ...
    return getattr(module, 'bmBinary2Array_cData')
...
def test_expected_behavior_contract():
    # Source MATLAB file: readWrite/bmBinary2Array_cData.m
