...
TARGET_FILE = Path(__file__).resolve().parents[4] / "monalisa_py/src/readWrite/bmCheckPath.py"
...
def _load_target_function():
    ...
    return getattr(module, 'bmCheckPath')
...
def test_expected_behavior_contract():
    # Source MATLAB file: readWrite/bmCheckPath.m
