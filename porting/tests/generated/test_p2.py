...
TARGET_FILE = Path(__file__).resolve().parents[4] / "monalisa_py/src/imDisp/bmImDeformFieldInverse_checkerboardDisp2.py"
...
def test_expected_behavior_contract():
    # Source MATLAB file: imDisp/bmImDeformFieldInverse_checkerboardDisp2.m
