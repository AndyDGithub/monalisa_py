...
TARGET_FILE = Path(__file__).resolve().parents[4] / "monalisa_py/src/rawDataReader/ismrmrd/dhIsmrmrdReadRawData.py"
...
def _load_target_function():
    ...
    return getattr(module, 'dhIsmrmrdReadRawData')
...
def test_expected_behavior_contract():
    # Source MATLAB file: rawDataReader/ismrmrd/dhIsmrmrdReadRawData.m
