...
TARGET_FILE = Path(__file__).resolve().parents[4] / "monalisa_py/src/coilSense/automatic/mlComputeCoilSensitivity.py"
...
def _load_target_function():
    ...
    return getattr(module, 'mlComputeCoilSensitivity')
...
def test_expected_behavior_contract():
    # Source MATLAB file: coilSense/automatic/mlComputeCoilSensitivity.m
