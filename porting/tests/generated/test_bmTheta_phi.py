...
TARGET_FILE = Path(__file__).resolve().parents[4] / "monalisa_py/src/geom3/bmTheta_phi.py"
...
def _load_target_function():
    ...
    return getattr(module, 'bmTheta_phi')
...
def test_expected_behavior_contract():
    # Source MATLAB file: geom3/bmTheta_phi.m
