...
TARGET_FILE = Path(__file__).resolve().parents[4] / "monalisa_py/src/image123/bmImShiftList_to_image.py"
...
def _load_target_function():
    ...
    return getattr(module, 'bmImShiftList_to_image')
...
def test_expected_behavior_contract():
    # Source MATLAB file: image123/bmImShiftList_to_image.m
