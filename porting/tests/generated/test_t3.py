...
TARGET_FILE = Path(__file__).resolve().parents[4] / "monalisa_py/src/fieldDisp3/bmFieldPlot3.py"
...
def test_expected_behavior_contract():
    # Source MATLAB file: fieldDisp3/bmFieldPlot3.m
