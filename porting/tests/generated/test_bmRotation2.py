...
TARGET_FILE = Path(__file__).resolve().parents[4] / "monalisa_py/src/linAlg2/bmRotation2.py"
...
def _load_target_function():
    ...
    return getattr(module, 'bmRotation2')
...
def test_expected_behavior_contract():
    # Source MATLAB file: linAlg2/bmRotation2.m
