...
TARGET_FILE = Path(__file__).resolve().parents[4] / "monalisa_py/src/geom2/bmVolumeElement_voronoi_box2.py"
...
def _load_target_function():
    ...
    return getattr(module, 'bmVolumeElement_voronoi_box2')
...
def test_expected_behavior_contract():
    # Source MATLAB file: geom2/bmVolumeElement_voronoi_box2.m
