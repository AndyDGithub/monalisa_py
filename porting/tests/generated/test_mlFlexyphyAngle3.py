...
TARGET_FILE = Path(__file__).resolve().parents[4] / "monalisa_py/src/traj3/mlFlexyphyAngle3.py"
...
def _load_target_function():
    ...
    return getattr(module, 'mlFlexyphyAngle3')
...
def test_expected_behavior_contract():
    # Source MATLAB file: traj3/mlFlexyphyAngle3.m
