...
TARGET_FILE = Path(__file__).resolve().parents[4] / "monalisa_py/src/arrayUtility/bmPermuteToPoint.py"
...
def _load_target_function():
    ...
    return getattr(module, 'bmPermuteToPoint')
...
def test_expected_behavior_contract():
    # Source MATLAB file: arrayUtility/bmPermuteToPoint.m
