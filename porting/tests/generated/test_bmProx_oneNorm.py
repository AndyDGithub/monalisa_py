...
TARGET_FILE = Path(__file__).resolve().parents[4] / "monalisa_py/src/linSpace/bmProx_oneNorm.py"
...
def _load_target_function():
    ...
    return getattr(module, 'bmProx_oneNorm')
...
def test_expected_behavior_contract():
    # Source MATLAB file: linSpace/bmProx_oneNorm.m
