...
TARGET_FILE = Path(__file__).resolve().parents[4] / "monalisa_py/src/linSpace/bmY_ve_reshape.py"
...
def _load_target_function():
    ...
    return getattr(module, 'bmY_ve_reshape')
...
def test_expected_behavior_contract():
    # Source MATLAB file: linSpace/bmY_ve_reshape.m
