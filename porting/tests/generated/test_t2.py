...
TARGET_FILE = Path(__file__).resolve().parents[4] / "monalisa_py/src/fieldDisp2/bmFieldPlot2.py"
...
def test_expected_behavior_contract():
    # Source MATLAB file: fieldDisp2/bmFieldPlot2.m
