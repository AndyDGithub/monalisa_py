...
TARGET_FILE = Path(__file__).resolve().parents[4] / "monalisa_py/src/mask123/bmElipsoidMask.py"
...
def _load_target_function():
    ...
    return getattr(module, 'bmElipsoidMask')
...
def test_expected_behavior_contract():
    # Source MATLAB file: mask123/bmElipsoidMask.m
