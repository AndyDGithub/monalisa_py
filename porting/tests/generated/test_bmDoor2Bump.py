...
TARGET_FILE = Path(__file__).resolve().parents[4] / "monalisa_py/src/function1/bmDoor2Bump.py"
...
def _load_target_function():
    ...
    return getattr(module, 'bmDoor2Bump')
...
def test_expected_behavior_contract():
    # Source MATLAB file: function1/bmDoor2Bump.m
