...
TARGET_FILE = Path(__file__).resolve().parents[4] / "monalisa_py/src/arrayUtility/bmIsColShape.py"
...
def _load_target_function():
    ...
    return getattr(module, 'bmIsColShape')
...
def test_expected_behavior_contract():
    # Source MATLAB file: arrayUtility/bmIsColShape.m
