...
TARGET_FILE = Path(__file__).resolve().parents[4] / "monalisa_py/src/rawDataReader/ismrmrd/mleIsmrmrdReader.py"
...
def _load_target_function():
    ...
    return getattr(module, 'mleIsmrmrdReader')
...
def test_expected_behavior_contract():
    # Source MATLAB file: rawDataReader/ismrmrd/mleIsmrmrdReader.m
