...
TARGET_FILE = Path(__file__).resolve().parents[4] / "monalisa_py/src/gridding123/m/bmImDeformField2sparseMat_ind_weight.py"
...
def _load_target_function():
    ...
    return getattr(module, 'bmImDeformField2sparseMat_ind_weight')
...
def test_expected_behavior_contract():
    # Source MATLAB file: gridding123/m/bmImDeformField2sparseMat_ind_weight.m
