...
TARGET_FILE = Path(__file__).resolve().parents[4] / "monalisa_py/src/rawDataReader/ismrmrd/dhIsmrmrdReadMetaData.py"
...
def _load_target_function():
    ...
    return getattr(module, 'dhIsmrmrdReadMetaData')
...
def test_expected_behavior_contract():
    # Source MATLAB file: rawDataReader/ismrmrd/dhIsmrmrdReadMetaData.m
