...
TARGET_FILE = Path(__file__).resolve().parents[4] / "monalisa_py/src/partition/bmCircular_ind_prev.py"
...
def _load_target_function():
    ...
    return getattr(module, 'bmCircular_ind_prev')
...
def test_expected_behavior_contract():
    # Source MATLAB file: partition/bmCircular_ind_prev.m
