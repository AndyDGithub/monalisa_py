...
TARGET_FILE = Path(__file__).resolve().parents[4] / "third_part/twix_for_monalisa/twix_map_obj_JH_for_monalisa.py"
...
def _load_target_function():
    ...
    return getattr(module, 'twix_map_obj_JH_for_monalisa')
...
def test_expected_behavior_contract():
    # Source MATLAB file: twix_for_monalisa/twix_map_obj_JH_for_monalisa.m
