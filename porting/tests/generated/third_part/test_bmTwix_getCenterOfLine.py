...
TARGET_FILE = Path(__file__).resolve().parents[4] / "third_part/twix_for_monalisa/bmTwix_getCenterOfLine.py"
...
def _load_target_function():
    ...
    return getattr(module, 'bmTwix_getCenterOfLine')
...
def test_expected_behavior_contract():
    # Source MATLAB file: twix_for_monalisa/bmTwix_getCenterOfLine.m
