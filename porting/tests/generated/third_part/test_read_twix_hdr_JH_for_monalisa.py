...
TARGET_FILE = Path(__file__).resolve().parents[4] / "third_part/twix_for_monalisa/read_twix_hdr_JH_for_monalisa.py"
...
def _load_target_function():
    ...
    return getattr(module, 'read_twix_hdr_JH_for_monalisa')
...
def test_expected_behavior_contract():
    # Source MATLAB file: twix_for_monalisa/read_twix_hdr_JH_for_monalisa.m
