...
TARGET_FILE = Path(__file__).resolve().parents[4] / "third_part/twix_for_monalisa/bmTwix.py"
...
def test_expected_behavior_contract():
    # Source MATLAB file: twix_for_monalisa/bmTwix.m
