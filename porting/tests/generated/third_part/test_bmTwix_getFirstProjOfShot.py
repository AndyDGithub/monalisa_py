...
TARGET_FILE = Path(__file__).resolve().parents[4] / "third_part/twix_for_monalisa/bmTwix_getFirstProjOfShot.py"
...
def test_expected_behavior_contract():
    # Source MATLAB file: twix_for_monalisa/bmTwix_getFirstProjOfShot.m
