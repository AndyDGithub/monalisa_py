...
TARGET_FILE = Path(__file__).resolve().parents[4] / "monalisa_py/src/mriPhi/bmMriPhi_signalList_to_phaseList.py"
...
def _load_target_function():
    ...
    return getattr(module, 'bmMriPhi_signalList_to_phaseList')
...
def test_expected_behavior_contract():
    # Source MATLAB file: mriPhi/bmMriPhi_signalList_to_phaseList.m
