...
TARGET_FILE = Path(__file__).resolve().parents[4] / "monalisa_py/src/mriPhi/bmMriPhi_phase_to_mask.py"
...
def _load_target_function():
    ...
    return getattr(module, 'bmMriPhi_phase_to_mask')
...
def test_expected_behavior_contract():
    # Source MATLAB file: mriPhi/bmMriPhi_phase_to_mask.m
