...
TARGET_FILE = Path(__file__).resolve().parents[4] / "monalisa_py/src/fourier3/bcaNeith_interpolatorExtraction3.py"
...
def _load_target_function():
    ...
    return getattr(module, 'InterpolatorExtraction')
...
def test_expected_behavior_contract():
    # Source MATLAB file: fourier3/bcaNeith_interpolatorExtraction3.m
