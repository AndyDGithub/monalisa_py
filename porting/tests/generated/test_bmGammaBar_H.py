...
TARGET_FILE = Path(__file__).resolve().parents[4] / "monalisa_py/src/physicNum/bmGammaBar_H.py"
...
def _load_target_function():
    ...
    return getattr(module, 'bmGammaBar_H')
...
def test_expected_behavior_contract():
    # Source MATLAB file: physicNum/bmGammaBar_H.m
