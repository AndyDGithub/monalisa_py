...
TARGET_FILE = Path(__file__).resolve().parents[4] / "monalisa_py/src/traj2/bmTraj_gaussRandom_linePartialCartesian2_x.py"
...
def _load_target_function():
    ...
    return getattr(module, 'bmTraj_gaussRandom_linePartialCartesian2_x')
...
def test_expected_behavior_contract():
    # Source MATLAB file: traj2/bmTraj_gaussRandom_linePartialCartesian2_x.m
