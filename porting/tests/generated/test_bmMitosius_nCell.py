...
TARGET_FILE = Path(__file__).resolve().parents[4] / "monalisa_py/src/mitosius/bmMitosius_nCell.py"
...
def _load_target_function():
    ...
    return getattr(module, 'bmMitosius_nCell')
...
def test_expected_behavior_contract():
    # Source MATLAB file: mitosius/bmMitosius_nCell.m
