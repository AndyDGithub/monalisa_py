...
TARGET_FILE = Path(__file__).resolve().parents[4] / "monalisa_py/src/mriRecon/function/bmUnionOfMriData_partialCartesian.py"
...
def _load_target_function():
    ...
    return getattr(module, 'bmUnionOfMriData_partialCartesian')
...
def test_expected_behavior_contract():
    # Source MATLAB file: mriRecon/function/bmUnionOfMriData_partialCartesian.m
