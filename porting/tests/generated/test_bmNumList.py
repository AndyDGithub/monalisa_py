...
TARGET_FILE = Path(__file__).resolve().parents[4] / "monalisa_py/src/readWrite/bmNumList.py"
...
def _load_target_function():
    ...
    return getattr(module, 'bmNumList')
...
def test_expected_behavior_contract():
    # Source MATLAB file: readWrite/bmNumList.m
