...
TARGET_FILE = Path(__file__).resolve().parents[4] / "monalisa_py/src/geom3/bmQuickFitPlane.py"
...
def _load_target_function():
    ...
    return getattr(module, 'bmQuickFitPlane')
...
def test_expected_behavior_contract():
    # Source MATLAB file: geom3/bmQuickFitPlane.m
