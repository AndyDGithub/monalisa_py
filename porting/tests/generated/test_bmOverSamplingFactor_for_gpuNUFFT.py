...
TARGET_FILE = Path(__file__).resolve().parents[4] / "monalisa_py/src/fourier123/other_function/bmOverSamplingFactor_for_gpuNUFFT.py"
...
def _load_target_function():
    ...
    return getattr(module, 'bmOverSamplingFactor_for_gpuNUFFT')
...
def test_expected_behavior_contract():
    # Source MATLAB file: fourier123/other_function/bmOverSamplingFactor_for_gpuNUFFT.m
