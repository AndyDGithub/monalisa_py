...
TARGET_FILE = Path(__file__).resolve().parents[4] / "monalisa_py/src/coilSense/automatic/selectROI.py"
...
def _load_target_function():
    ...
    return getattr(module, 'selectROI')
...
def test_expected_behavior_contract():
    # Source MATLAB file: coilSense/automatic/selectROI.m
