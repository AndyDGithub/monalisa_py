...
TARGET_FILE = Path(__file__).resolve().parents[4] / "monalisa_py/src/traj1/bmTraj_random1_k0.py"
...
def _load_target_function():
    ...
    return getattr(module, 'bmTraj_random1_k0')
...
def test_expected_behavior_contract():
    # Source MATLAB file: traj1/bmTraj_random1_k0.m
