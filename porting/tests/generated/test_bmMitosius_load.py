...
TARGET_FILE = Path(__file__).resolve().parents[4] / "monalisa_py/src/mitosius/bmMitosius_load.py"
...
def _load_target_function():
    ...
    return getattr(module, 'bmMitosius_load')
...
def test_expected_behavior_contract():
    # Source MATLAB file: mitosius/bmMitosius_load.m
