...
TARGET_FILE = Path(__file__).resolve().parents[4] / "monalisa_py/src/fourier3/bcaNeith3.py"
...
def _load_target_function():
    ...
    return getattr(module, 'MATLABGrappa')
...
def test_expected_behavior_contract():
    # Source MATLAB file: fourier3/bcaNeith3.m
