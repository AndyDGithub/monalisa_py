...
TARGET_FILE = Path(__file__).resolve().parents[4] / "monalisa_py/src/imReg/class/bmImReg_solidTransform.py"
...
def _load_target_function():
    ...
    return getattr(module, 'bmImReg_solidTransform')
...
def test_expected_behavior_contract():
    # Source MATLAB file: imReg/class/bmImReg_solidTransform.m
