...
TARGET_FILE = Path(__file__).resolve().parents[4] / "monalisa_py/src/mask3/bmSmoothMask3.py"
...
def _load_target_function():
    ...
    return getattr(module, 'bmSmoothMask3')
...
def test_expected_behavior_contract():
    # Source MATLAB file: mask3/bmSmoothMask3.m
