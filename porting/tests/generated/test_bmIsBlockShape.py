...
TARGET_FILE = Path(__file__).resolve().parents[4] / "monalisa_py/src/arrayUtility/bmIsBlockShape.py"
...
def _load_target_function():
    ...
    return getattr(module, 'bmIsBlockShape')
...
def test_expected_behavior_contract():
    # Source MATLAB file: arrayUtility/bmIsBlockShape.m
