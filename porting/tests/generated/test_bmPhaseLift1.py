...
TARGET_FILE = Path(__file__).resolve().parents[4] / "monalisa_py/src/phaseLift/bmPhaseLift1.py"
...
def _load_target_function():
    ...
    return getattr(module, 'bmPhaseLift1')
...
def test_expected_behavior_contract():
    # Source MATLAB file: phaseLift/bmPhaseLift1.m
