...
TARGET_FILE = Path(__file__).resolve().parents[4] / "monalisa_py/src/mriPhi/bmMriPhi_signalList_to_phase.py"
...
def _load_target_function():
    ...
    return getattr(module, 'bmMriPhi_signalList_to_phase')
...
def test_expected_behavior_contract():
    # Source MATLAB file: mriPhi/bmMriPhi_signalList_to_phase.m
