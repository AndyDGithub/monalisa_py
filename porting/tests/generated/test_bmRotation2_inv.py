...
TARGET_FILE = Path(__file__).resolve().parents[4] / "monalisa_py/src/linAlg2/bmRotation2_inv.py"
...
def _load_target_function():
    ...
    return getattr(module, 'bmRotation2_inv')
...
def test_expected_behavior_contract():
    # Source MATLAB file: linAlg2/bmRotation2_inv.m
