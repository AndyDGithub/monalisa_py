...
TARGET_FILE = Path(__file__).resolve().parents[4] / "monalisa_py/src/mask2/bmOutBorderMask2.py"
...
def _load_target_function():
    ...
    return getattr(module, 'bmOutBorderMask2')
...
def test_expected_behavior_contract():
    # Source MATLAB file: mask2/bmOutBorderMask2.m
