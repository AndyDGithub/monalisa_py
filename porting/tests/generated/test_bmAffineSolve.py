...
TARGET_FILE = Path(__file__).resolve().parents[4] / "monalisa_py/src/quickSolve/bmAffineSolve.py"
...
def _load_target_function():
    ...
    return getattr(module, 'bmAffineSolve')
...
def test_expected_behavior_contract():
    # Source MATLAB file: quickSolve/bmAffineSolve.m
