...
TARGET_FILE = Path(__file__).resolve().parents[4] / "monalisa_py/src/geom123/bmVolumeElement_replace_cartesian.py"
...
def _load_target_function():
    ...
    return getattr(module, 'bmVolumeElement_replace_cartesian')
...
def test_expected_behavior_contract():
    # Source MATLAB file: geom123/bmVolumeElement_replace_cartesian.m
