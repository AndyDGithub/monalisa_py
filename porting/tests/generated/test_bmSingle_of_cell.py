...
TARGET_FILE = Path(__file__).resolve().parents[4] / "monalisa_py/src/arrayUtility/bmSingle_of_cell.py"
...
def _load_target_function():
    ...
    return getattr(module, 'bmSingle_of_cell')
...
def test_expected_behavior_contract():
    # Source MATLAB file: arrayUtility/bmSingle_of_cell.m
