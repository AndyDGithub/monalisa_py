...
TARGET_FILE = Path(__file__).resolve().parents[4] / "monalisa_py/src/readWrite/bmGetDir.py"
...
def _load_target_function():
    ...
    return getattr(module, 'bmGetDir')
...
def test_expected_behavior_contract():
    # Source MATLAB file: readWrite/bmGetDir.m
