...
TARGET_FILE = Path(__file__).resolve().parents[4] / "monalisa_py/src/coilSense/simu/bcaNeith_coilSensitivitySimulation2.py"
...
def _load_target_function():
    ...
    return getattr(module, 'bcaNeith_coilSensitivitySimulation2')
...
def test_expected_behavior_contract():
    # Source MATLAB file: coilSense/simu/bcaNeith_coilSensitivitySimulation2.m
