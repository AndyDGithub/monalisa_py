...
TARGET_FILE = Path(__file__).resolve().parents[4] / "monalisa_py/src/geom1/bmVolumeElement1.py"
...
def _load_target_function():
    ...
    return getattr(module, 'bmVolumeElement1')
...
def test_expected_behavior_contract():
    # Source MATLAB file: geom1/bmVolumeElement1.m
