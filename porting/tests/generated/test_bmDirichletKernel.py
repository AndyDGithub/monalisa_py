...
TARGET_FILE = Path(__file__).resolve().parents[4] / "monalisa_py/src/function1/bmDirichletKernel.py"
...
def _load_target_function():
    ...
    return getattr(module, 'bmDirichletKernel')
...
def test_expected_behavior_contract():
    # Source MATLAB file: function1/bmDirichletKernel.m
