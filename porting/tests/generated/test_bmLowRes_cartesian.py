...
TARGET_FILE = Path(__file__).resolve().parents[4] / "monalisa_py/src/mriRecon/function/bmLowRes_cartesian.py"
...
def _load_target_function():
    ...
    return getattr(module, 'bmLowRes_cartesian')
...
def test_expected_behavior_contract():
    # Source MATLAB file: mriRecon/function/bmLowRes_cartesian.m
