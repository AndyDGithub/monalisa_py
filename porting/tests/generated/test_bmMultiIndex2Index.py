...
TARGET_FILE = Path(__file__).resolve().parents[4] / "monalisa_py/src/arrayUtility/bmMultiIndex2Index.py"
...
def _load_target_function():
    ...
    return getattr(module, 'bmMultiIndex2Index')
...
def test_expected_behavior_contract():
    # Source MATLAB file: arrayUtility/bmMultiIndex2Index.m
