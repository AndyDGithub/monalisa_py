...
TARGET_FILE = Path(__file__).resolve().parents[4] / "monalisa_py/src/mriPhi/bmMriPhi_graphical_frequency_selector.py"
...
def _load_target_function():
    ...
    return getattr(module, 'bmMriPhi_graphical_frequency_selector')
...
def test_expected_behavior_contract():
    # Source MATLAB file: mriPhi/bmMriPhi_graphical_frequency_selector.m
