...
TARGET_FILE = Path(__file__).resolve().parents[4] / "monalisa_py/src/partition/bmScalarBinning.py"
...
def _load_target_function():
    ...
    return getattr(module, 'bmScalarBinning')
...
def test_expected_behavior_contract():
    # Source MATLAB file: partition/bmScalarBinning.m
