...
TARGET_FILE = Path(__file__).resolve().parents[4] / "monalisa_py/src/interp2/bmPhaseInterp2.py"
...
def _load_target_function():
    ...
    return getattr(module, 'bmPhaseInterp2')
...
def test_expected_behavior_contract():
    # Source MATLAB file: interp2/bmPhaseInterp2.m
