...
TARGET_FILE = Path(__file__).resolve().parents[4] / "monalisa_py/src/dialog/bmGetString.py"
...
def _load_target_function():
    ...
    return getattr(module, 'bmGetString')
...
def test_expected_behavior_contract():
    # Source MATLAB file: dialog/bmGetString.m
