...
TARGET_FILE = Path(__file__).resolve().parents[4] / "monalisa_py/src/readWrite/bmTextFile2Cell.py"
...
def _load_target_function():
    ...
    return getattr(module, 'bmTextFile2Cell')
...
def test_expected_behavior_contract():
    # Source MATLAB file: readWrite/bmTextFile2Cell.m
