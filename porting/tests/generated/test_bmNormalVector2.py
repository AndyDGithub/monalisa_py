...
TARGET_FILE = Path(__file__).resolve().parents[4] / "monalisa_py/src/geom2/bmNormalVector2.py"
...
def _load_target_function():
    ...
    return getattr(module, 'bmNormalVector2')
...
def test_expected_behavior_contract():
    # Source MATLAB file: geom2/bmNormalVector2.m
