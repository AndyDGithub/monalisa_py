...
TARGET_FILE = Path(__file__).resolve().parents[4] / "monalisa_py/src/coilSense/from_prescan/bmCoilSense_prescan_mask.py"
...
def _load_target_function():
    ...
    return getattr(module, 'bmCoilSense_prescan_mask')
...
def test_expected_behavior_contract():
    # Source MATLAB file: coilSense/from_prescan/bmCoilSense_prescan_mask.m
