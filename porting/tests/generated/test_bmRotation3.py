...
TARGET_FILE = Path(__file__).resolve().parents[4] / "monalisa_py/src/linAlg3/bmRotation3.py"
...
def _load_target_function():
    ...
    return getattr(module, 'bmRotation3')
...
def test_expected_behavior_contract():
    # Source MATLAB file: linAlg3/bmRotation3.m
