...
TARGET_FILE = Path(__file__).resolve().parents[4] / "monalisa_py/src/fourier123/other_function/bmFourierModulation.py"
...
def _load_target_function():
    ...
    return getattr(module, 'bmFourierModulation')
...
def test_expected_behavior_contract():
    # Source MATLAB file: fourier123/other_function/bmFourierModulation.m
