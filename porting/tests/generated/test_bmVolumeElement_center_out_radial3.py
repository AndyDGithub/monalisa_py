...
TARGET_FILE = Path(__file__).resolve().parents[4] / "monalisa_py/src/geom3/bmVolumeElement_center_out_radial3.py"
...
def _load_target_function():
    ...
    return getattr(module, 'bmVolumeElement_center_out_radial3')
...
def test_expected_behavior_contract():
    # Source MATLAB file: geom3/bmVolumeElement_center_out_radial3.m
