...
TARGET_FILE = Path(__file__).resolve().parents[4] / "monalisa_py/src/coilSense/automatic/thresholdRMS_MIP.py"
...
def _load_target_function():
    ...
    return getattr(module, 'thresholdRMS_MIP')
...
def test_expected_behavior_contract():
    # Source MATLAB file: coilSense/automatic/thresholdRMS_MIP.m
