...
TARGET_FILE = Path(__file__).resolve().parents[4] / "monalisa_py/src/interp3/bmPhaseInterp3.py"
...
def _load_target_function():
    ...
    return getattr(module, 'bmPhaseInterp3')
...
def test_expected_behavior_contract():
    # Source MATLAB file: interp3/bmPhaseInterp3.m
