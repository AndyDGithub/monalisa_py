...
TARGET_FILE = Path(__file__).resolve().parents[4] / "monalisa_py/src/optim/bmTV_gradient.py"
...
def _load_target_function():
    ...
    return getattr(module, 'bmTV_gradient')
...
def test_expected_behavior_contract():
    # Source MATLAB file: optim/bmTV_gradient.m
