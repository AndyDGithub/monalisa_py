...
TARGET_FILE = Path(__file__).resolve().parents[4] / "monalisa_py/src/dicom/bmDicomWrite.py"
...
def _load_target_function():
    ...
    return getattr(module, 'bmDicomWrite')
...
def test_expected_behavior_contract():
    # Source MATLAB file: dicom/bmDicomWrite.m
