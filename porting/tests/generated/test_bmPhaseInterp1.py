...
TARGET_FILE = Path(__file__).resolve().parents[4] / "monalisa_py/src/interp1/bmPhaseInterp1.py"
...
def _load_target_function():
    ...
    return getattr(module, 'bmPhaseInterp1')
...
def test_expected_behavior_contract():
    # Source MATLAB file: interp1/bmPhaseInterp1.m
