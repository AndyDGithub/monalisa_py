...
TARGET_FILE = Path(__file__).resolve().parents[4] / "monalisa_py/src/phaseLift/bmLocalPhaseLift3.py"
...
def _load_target_function():
    ...
    return getattr(module, 'bmLocalPhaseLift3')
...
def test_expected_behavior_contract():
    # Source MATLAB file: phaseLift/bmLocalPhaseLift3.m
