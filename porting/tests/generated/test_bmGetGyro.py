...
TARGET_FILE = Path(__file__).resolve().parents[4] / "monalisa_py/src/physicNum/bmGetGyro.py"
...
def _load_target_function():
    ...
    return getattr(module, 'bmGetGyro')
...
def test_expected_behavior_contract():
    # Source MATLAB file: physicNum/bmGetGyro.m
