...
TARGET_FILE = Path(__file__).resolve().parents[4] / "monalisa_py/src/optim/bmBackGradient.py"
...
def _load_target_function():
    ...
    return getattr(module, 'bmBackGradient')
...
def test_expected_behavior_contract():
    # Source MATLAB file: optim/bmBackGradient.m
