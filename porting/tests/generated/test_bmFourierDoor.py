...
TARGET_FILE = Path(__file__).resolve().parents[4] / "monalisa_py/src/fourier1/bmFourierDoor.py"
...
def _load_target_function():
    ...
    return getattr(module, 'bmFourierDoor')
...
def test_expected_behavior_contract():
    # Source MATLAB file: fourier1/bmFourierDoor.m
