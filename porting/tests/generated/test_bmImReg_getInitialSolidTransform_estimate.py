...
TARGET_FILE = Path(__file__).resolve().parents[4] / "monalisa_py/src/imReg/m/bmImReg_getInitialSolidTransform_estimate.py"
...
def _load_target_function():
    ...
    return getattr(module, 'bmImReg_getInitialSolidTransform_estimate')
...
def test_expected_behavior_contract():
    # Source MATLAB file: imReg/m/bmImReg_getInitialSolidTransform_estimate.m
