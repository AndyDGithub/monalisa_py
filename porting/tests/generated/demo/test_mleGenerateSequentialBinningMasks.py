...
TARGET_FILE = Path(__file__).resolve().parents[4] / "demo/function_demo/function_seqBinning/mleGenerateSequentialBinningMasks.py"
...
def _load_target_function():
    ...
    return getattr(module, 'mleGenerateSequentialBinningMasks')
...
def test_expected_behavior_contract():
    # Source MATLAB file: function_demo/function_seqBinning/mleGenerateSequentialBinningMasks.m
