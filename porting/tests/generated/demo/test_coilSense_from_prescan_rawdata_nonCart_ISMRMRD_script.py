...
TARGET_FILE = Path(__file__).resolve().parents[4] / "demo/script_demo/script_coilSense/coilSense_from_prescan_rawdata_nonCart_ISMRMRD_script.py"
...
def _load_target_function():
    ...
    return getattr(module, 'coilSense_from_prescan_rawdata_nonCart_ISMRMRD_script')
...
def test_expected_behavior_contract():
    # Source MATLAB file: script_demo/script_coilSense/coilSense_from_prescan_rawdata_nonCart_ISMRMRD_script.m
