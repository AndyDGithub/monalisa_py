...
TARGET_FILE = Path(__file__).resolve().parents[4] / "demo/script_demo/script_docker/testDocker.py"
...
def _load_target_function():
    ...
    return getattr(module, 'testDocker')
...
def test_expected_behavior_contract():
    # Source MATLAB file: script_demo/script_docker/testDocker.m
