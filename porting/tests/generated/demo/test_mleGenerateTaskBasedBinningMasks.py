...
TARGET_FILE = Path(__file__).resolve().parents[4] / "demo/function_demo/function_seqBinning/mleGenerateTaskBasedBinningMasks.py"
...
def _load_target_function():
    ...
    return getattr(module, 'mleGenerateTaskBasedBinningMasks')
...
def test_expected_behavior_contract():
    # Source MATLAB file: function_demo/function_seqBinning/mleGenerateTaskBasedBinningMasks.m
