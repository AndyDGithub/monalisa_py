...
TARGET_FILE = Path(__file__).resolve().parents[4] / "monalisa_py/src/readWrite/bmDirList.py"
...
def _load_target_function():
    ...
    return getattr(module, 'bmDirList')
...
def test_expected_behavior_contract():
    # Source MATLAB file: readWrite/bmDirList.m
