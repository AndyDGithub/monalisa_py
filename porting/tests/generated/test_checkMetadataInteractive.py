...
TARGET_FILE = Path(__file__).resolve().parents[4] / "monalisa_py/src/rawDataReader/checkMetadataInteractive.py"
...
def _load_target_function():
    ...
    return getattr(module, 'checkMetadataInteractive')
...
def test_expected_behavior_contract():
    # Source MATLAB file: rawDataReader/checkMetadataInteractive.m
