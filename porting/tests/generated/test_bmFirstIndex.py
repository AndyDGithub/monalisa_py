...
TARGET_FILE = Path(__file__).resolve().parents[4] / "monalisa_py/src/arrayUtility/bmFirstIndex.py"
...
def _load_target_function():
    ...
    return getattr(module, 'bmFirstIndex')
...
def test_expected_behavior_contract():
    # Source MATLAB file: arrayUtility/bmFirstIndex.m
