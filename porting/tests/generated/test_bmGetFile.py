...
TARGET_FILE = Path(__file__).resolve().parents[4] / "monalisa_py/src/readWrite/bmGetFile.py"
...
def _load_target_function():
    ...
    return getattr(module, 'bmGetFile')
...
def test_expected_behavior_contract():
    # Source MATLAB file: readWrite/bmGetFile.m
