...
TARGET_FILE = Path(__file__).resolve().parents[4] / "monalisa_py/src/varargin/bmVarargin_rLineMask.py"
...
def _load_target_function():
    ...
    return getattr(module, 'bmVarargin_rLineMask')
...
def test_expected_behavior_contract():
    # Source MATLAB file: varargin/bmVarargin_rLineMask.m
