...
TARGET_FILE = Path(__file__).resolve().parents[4] / "monalisa_py/src/rawDataReader/ismrmrd/ISMRMRD_readParam.py"
...
def _load_target_function():
    ...
    return getattr(module, 'ISMRMRD_readParam')
...
def test_expected_behavior_contract():
    # Source MATLAB file: rawDataReader/ismrmrd/ISMRMRD_readParam.m
