...
TARGET_FILE = Path(__file__).resolve().parents[4] / "monalisa_py/src/geom123/bmVoronoi_with_test.py"
...
def _load_target_function():
    ...
    return getattr(module, 'bmVoronoi_with_test')
...
def test_expected_behavior_contract():
    # Source MATLAB file: geom123/bmVoronoi_with_test.m
