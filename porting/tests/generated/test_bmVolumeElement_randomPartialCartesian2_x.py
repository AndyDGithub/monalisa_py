...
TARGET_FILE = Path(__file__).resolve().parents[4] / "monalisa_py/src/geom2/bmVolumeElement_randomPartialCartesian2_x.py"
...
def _load_target_function():
    ...
    return getattr(module, 'bmVolumeElement_randomPartialCartesian2_x')
...
def test_expected_behavior_contract():
    # Source MATLAB file: geom2/bmVolumeElement_randomPartialCartesian2_x.m
