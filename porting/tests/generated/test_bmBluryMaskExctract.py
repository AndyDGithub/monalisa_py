...
TARGET_FILE = Path(__file__).resolve().parents[4] / "monalisa_py/src/maskN/bmBluryMaskExctract.py"
...
def _load_target_function():
    ...
    return getattr(module, 'bmBluryMaskExctract')
...
def test_expected_behavior_contract():
    # Source MATLAB file: maskN/bmBluryMaskExctract.m
