...
TARGET_FILE = Path(__file__).resolve().parents[4] / "monalisa_py/src/rawDataReader/ismrmrd/bmISMRMRD_data.py"
...
def _load_target_function():
    ...
    return getattr(module, 'bmISMRMRD_data')
...
def test_expected_behavior_contract():
    # Source MATLAB file: rawDataReader/ismrmrd/bmISMRMRD_data.m
