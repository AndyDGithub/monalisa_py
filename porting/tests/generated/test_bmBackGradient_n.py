...
TARGET_FILE = Path(__file__).resolve().parents[4] / "monalisa_py/src/optim/bmBackGradient_n.py"
...
def _load_target_function():
    ...
    return getattr(module, 'bmBackGradient_n')
...
def test_expected_behavior_contract():
    # Source MATLAB file: optim/bmBackGradient_n.m
