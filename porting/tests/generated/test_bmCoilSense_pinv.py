...
TARGET_FILE = Path(__file__).resolve().parents[4] / "monalisa_py/src/coilSense/map/bmCoilSense_pinv.py"
...
def _load_target_function():
    ...
    return getattr(module, 'bmCoilSense_pinv')
...
def test_expected_behavior_contract():
    # Source MATLAB file: coilSense/map/bmCoilSense_pinv.m
