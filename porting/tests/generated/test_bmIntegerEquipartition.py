...
TARGET_FILE = Path(__file__).resolve().parents[4] / "monalisa_py/src/partition/bmIntegerEquipartition.py"
...
def _load_target_function():
    ...
    return getattr(module, 'bmIntegerEquipartition')
...
def test_expected_behavior_contract():
    # Source MATLAB file: partition/bmIntegerEquipartition.m
