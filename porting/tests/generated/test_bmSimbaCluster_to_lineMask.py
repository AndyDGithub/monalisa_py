...
TARGET_FILE = Path(__file__).resolve().parents[4] / "monalisa_py/src/mriRecon/function/bmSimbaCluster_to_lineMask.py"
...
def _load_target_function():
    ...
    return getattr(module, 'bmSimbaCluster_to_lineMask')
...
def test_expected_behavior_contract():
    # Source MATLAB file: mriRecon/function/bmSimbaCluster_to_lineMask.m
