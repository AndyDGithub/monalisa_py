...
TARGET_FILE = Path(__file__).resolve().parents[4] / "monalisa_py/src/coilSense/nonCart/bmCoilSense_nonCart_primary.py"
...
def _load_target_function():
    ...
    return getattr(module, 'bmCoilSense_nonCart_primary')
...
def test_expected_behavior_contract():
    # Source MATLAB file: coilSense/nonCart/bmCoilSense_nonCart_primary.m
