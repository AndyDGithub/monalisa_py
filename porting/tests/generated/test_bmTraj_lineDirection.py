...
TARGET_FILE = Path(__file__).resolve().parents[4] / "monalisa_py/src/traj123/bmTraj_lineDirection.py"
...
def _load_target_function():
    ...
    return getattr(module, 'bmTraj_lineDirection')
...
def test_expected_behavior_contract():
    # Source MATLAB file: traj123/bmTraj_lineDirection.m
