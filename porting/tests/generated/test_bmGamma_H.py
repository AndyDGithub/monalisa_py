...
TARGET_FILE = Path(__file__).resolve().parents[4] / "monalisa_py/src/physicNum/bmGamma_H.py"
...
def _load_target_function():
    ...
    return getattr(module, 'bmGamma_H')
...
def test_expected_behavior_contract():
    # Source MATLAB file: physicNum/bmGamma_H.m
