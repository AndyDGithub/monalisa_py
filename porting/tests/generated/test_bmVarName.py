...
TARGET_FILE = Path(__file__).resolve().parents[4] / "monalisa_py/src/readWrite/bmVarName.py"
...
def _load_target_function():
    ...
    return getattr(module, 'bmVarName')
...
def test_expected_behavior_contract():
    # Source MATLAB file: readWrite/bmVarName.m
