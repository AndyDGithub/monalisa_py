...
def bmDFT1(x, N_u, dK_u):
    # Fx = bmDFT1(x, N_u, dK_u)
    #
    # This function computes the discrete Fourier transform for one dimensional
    # data using a fast Fourier transform (FFT) algorithm.
    #
    # Authors:
    # Bastien Milani
    # CHUV and UNIL
    ...
    #
    # Parameters:
    # x (1D array): Contains the data on which the FFT should be performed.
    ...
    argSize = np.shape(x)
    # Reshape x to be seperated into blocks of size N_u ([96])
